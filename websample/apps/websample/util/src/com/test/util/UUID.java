...
public final class UUID implements java.io.Serializable, Comparable {
     ...
     * <ul>
     * <li>0    Reserved for backward compatibility
    ...
    public int compareTo(Object uuidval) {
    	UUID val = (UUID)uuidval;
        // The ordering is intentionally set up so that the UUIDs
        // can simply be numerically compared as two numbers
        return (this.mostSigBits < val.mostSigBits ? -1 : 
                (this.mostSigBits > val.mostSigBits ? 1 :
    ...
    public static String randomUUIDWithoutDash() {
    	UUID instance = randomUUID();
    	String result = null;
    	result = instance.toString().replaceAll("-","").toUpperCase();
    	return result;
    }    
}
