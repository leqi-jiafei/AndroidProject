package com.leqi.test.main.activities;
...
public class SplashActivity extends Activity implements QBCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QBSettings.getInstance().fastConfigInit("3066", "naKbkuuUg6VLaCb", "JU5ta3q2nSQfKjA");
        ...
        qbUser.setLogin("leqi123456");
        qbUser.setPassword("leqi1234");
